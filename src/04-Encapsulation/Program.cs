...
public class BankAccount
{
    ...
    // INTERVIEW ANSWER: C# 13 field-backed properties let you use the `field`
    // keyword to reference the compiler-generated backing field. This eliminates
    // the manual `_email` field while keeping custom validation in the setter.
    public string Email
    {
        get;
        set
